...
\cs{prettyinit:} or \cs{prettyinitterm:} must also be called before calling the functions in this section.
...
\begin{function}{\prettyN,\prettyX,\prettyO,\prettyV,\prettyW,\prettyinit,\prettyinitterm\prettyshowN,\prettyshowC}
	\begin{syntax}
