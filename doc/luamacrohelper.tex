...
\begin{luafn}{L.begin_groupT, L.end_groupT, L.math_toggleT, L.math_superscriptT, L.math_subscriptT}
	\begin{syntax}
L.begin_groupT(...)
L.end_groupT(...)
L.math_toggleT(...)
...
\begin{luafn}{L.exp_o}
	...
	\end{syntax}
	Return the |o|-expansion of \meta{token list}.
...
\begin{luafn}{L.to_str}
	\begin{syntax}
		L.to_str(\meta{token list}) -> string
	\end{syntax}
...
\begin{luafn}{L.detokenize_str}
	...
	Identical to \texttt{L.to_str(L.detokenize(\meta{token list}))}.
\end{luafn}
...
\begin{luafn}{L.tokenize}
	\begin{syntax}
		L.tokenize(string) -> \meta{token list}
	\end{syntax}
	Tokenize some \TeX\ code under the current catcode \reg.
\end{luafn}
